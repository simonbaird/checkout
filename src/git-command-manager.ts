...
export interface IGitCommandManager {
  ...
  fetch(refSpec: string[], fetchDepth: number, showProgress: boolean): Promise<void>
...
class GitCommandManager {
  ...
  async fetch(refSpec: string[], fetchDepth: number, showProgress: boolean): Promise<void> {
